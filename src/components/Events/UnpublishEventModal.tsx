...
export default function UnpublishEventModal({ onCancel, onConfirm }: UnpublishEventModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
      ...
      >
        <div
          ...
          style={{ width: 40, height: 40, padding: 8, backgroundColor: "#282A2D" }}
        >
          <ToggleOnIcon className="w-5 h-5 text-neutral-300" />
        </div>
 
        <div className="text-center">
          <p className="text-white text-lg font-semibold mb-1">Unpublish Event?</p>
          <p className="text-neutral-400 text-sm">Do you want to unpublish this event?</p>
        </div>
