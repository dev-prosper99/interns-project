...
export default function OrganizerPitch() {
  return (
    <div className="bg-purple-900">
      <div className="max-w-6xl mx-auto py-16   flex flex-col md:flex-row items-center gap-10">
        <div className="flex flex-col gap-6 items-start lg:w-1/2 px-4 sm:px-0">
          ...
          <p className="font-poppins font-medium text-sm sm:text-base leading-6 text-neutral-100">
            From intimate workshops to stadium concerts, TixO gives you
            everything you need to create, sell, and manage events with
            confidence.
          </p>
          <ul className="flex flex-col gap-4 w-full">
            {bullets.map((bullet, i) => (
              <li
                key={i}
                className="flex flex-row items-center gap-2 text-neutral-200 text-sm"
              >
        ...
        <div className="w-70 sm:w-100 md:w-140 lg:w-145 rounded-2xl bg-neutral-900 mx-auto lg:mx-0">
          <img
            src={organizerImg}
