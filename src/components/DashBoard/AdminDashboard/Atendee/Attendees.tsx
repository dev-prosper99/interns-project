...
import { Search, Download, Copy, X, Send } from "lucide-react";
      ...
      >
        <div className="mb-5 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-8 w-8 text-white" onClick={onClose} aria-label="Close">
              <X className="h-4 w-4" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 flex gap-3">
          ...
          <Button variant="primary" className="flex-1 text-white">
            Mark Checked-in
          </Button>
        </div>
      </div>
        ...
        <main className="flex-1 p-6">
          ...
          <div className="overflow-hidden rounded-xl border border-white/10 bg-neutral-1000">
                ...
                <tbody>
                  {filtered.map((a) => (
                    <tr key={a.id} className="border-b border-white/5 last:border-0 hover:bg-white/">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="truncate text-xs text-neutral-500">{a.email}</div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className={`px-4 py-3 ${a.amountPaid === "Free" ? "text-emerald-400" : "text-neutral-300"}`}>
                      ...
                      <td className="px-4 py-3">
                        <Button
                          variant="primary"
                          className="h-auto p-0 text-sm font-medium text-violet-400 hover:text-violet-300 p-2"
            ...
            <div className="flex items-center justify-between border-t border-white/10 px-4 py-3 text-sm text-neutral-500">
              ...
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="border-white/10 text-neutral-400 hover:bg-white/5">
                  Prev
                </Button>
                <Button size="sm" className="bg-violet-600 hover:bg-violet-600/90">
                  1
                </Button>
                <Button variant="outline" size="sm" className="border-white/10 text-neutral-400 hover:bg-white/5">
                  Next
