            ...
            <div className="min-h-screen flex flex-col lg:flex-row bg-black text-white">
                  ...
                  <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col justify-between p-10 w-full">
                              ...
                              <div>
                                    <p className="text-4xl font-bold leading-tight mb-4">Nigeria's events are waiting for you.</p>
                  ...
                  <div className="flex-1 flex flex-col">
                        ...
                        <div className="flex-1 flex items-center justify-center px-4 py-10">
                              <div className="w-full max-w-md bg-neutral-900 rounded-2xl p-8">
                                    ...
                                    <p className="text-neutral-400 text-sm text-center mb-6">No worries, we will send you reset instructions.</p>
                                    <form onSubmit={handleSubmit}>
                                          ...
                                          />
                                          <p className="text-xs text-neutral-500 mt-2">Enter the email with which you've registered.</p>
                                          <button
                                                type="submit"
