                  ...
                  <div className="flex w-full items-center justify-center h-screen overflow-y-auto not-last-of-type: bg-900 px-6 py-16 lg:w-1/2">
                        <div className="w-full max-w-150">
                              ...
                              <div className="rounded-xl bg-neutral-925 p-8">
                                    ...
                                    <h2 className="text-center text-3xl font-bold text-white">Password Reset Successfully</h2>

                                    <p className="mt-2 text-center text-sm text-gray-400">Your Password has been successfuly reset</p>
